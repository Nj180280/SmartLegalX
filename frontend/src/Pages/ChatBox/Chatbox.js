...
function Chatbot() {
    ...
    return (
        <div className="container mt-5">
            <h1 style={{ color: 'white' }}>LegalChatBot</h1>
            <div className="chat-box mt-3" ref={chatBoxRef}>
                {messages}
            </div>
            <div className="form-group mt-3">
                <textarea className="form-control" rows="3" placeholder="Ask your query here . . . " id="message-input" ref={messageInputRef} onKeyDown={handleKeyDown}></textarea>
            ...
            <button type="button" className="btn btn-primary position-relative" id="send-btn" onClick={sendMessage}>Send</button>
        </div>
    );
}
