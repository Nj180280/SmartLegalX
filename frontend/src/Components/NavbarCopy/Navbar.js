...
const Navbar = () => {
  const { isLoggedIn, handleLogout } = useState(true);
    ...
    <nav className={`navbar-main ${isOpen ? 'active' : ''}`}>
      <div className="navbar-container">
        ...
        <div className={`navbar-links ${isOpen ? 'active' : ''}`}>
          ...
          <NavLink to="/Video Summarry" onClick={() => setIsOpen(false)}>
            Special Offers
          </NavLink>
          <NavLink to="/AskLawyers" onClick={() => setIsOpen(false)}>
            My Bookings
          </NavLink>
          <NavLink to="/DocumentMaker" onClick={() => setIsOpen(false)}>
            Blogs
          </NavLink>
